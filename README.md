...
### 💻 Featured Projects
- **[Vehicle Damage Analyzer](https://github.com/Grapenator/car-damage-ai)** – An AI-powered web app that analyzes vehicle photos to detect and describe vehicle damage using a FastAPI backend and React frontend.
...
- Cloud & Tools: Amazon Web Services (AWS), Vercel, Render
